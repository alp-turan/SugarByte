...
public class IntensiveLogbook extends BaseUI {
    ...
    // Fields for blood sugar, carbs, exercise, insulin, and medications
    ...
    private JTextField[] insulinDoseFields = new JTextField[7];
    private JTextField[] otherMedicationsFields = new JTextField[7];
    ...
    private void buildUI() {
        ...
        for (int i = 0; i < ROW_LABELS.length; i++) {
            ...
            otherMedicationsFields[i] = new JTextField(10);
            ...
            gbc.gridx = 7;
            centerPanel.add(new JLabel("Insulin Dose:"), gbc);
            gbc.gridx = 8;
            centerPanel.add(insulinDoseFields[i], gbc);

            gbc.gridx = 9;
            centerPanel.add(new JLabel("Other Medications:"), gbc);
            gbc.gridx = 10;
            centerPanel.add(otherMedicationsFields[i], gbc);
        }
    ...
    private void handleSaveAll() {
        for (int i = 0; i < ROW_LABELS.length; i++) {
            ...
            String otherMedications = otherMedicationsFields[i].getText();

            if (bg > 0 || carbs > 0 || !exerciseType.isEmpty() || exerciseDuration > 0 || insulinDose > 0 || !otherMedications.isEmpty()) {
                ...
                entry.setOtherMedications(otherMedications);
                entry.setFoodDetails("Intensive Logbook - " + ROW_LABELS[i]);
